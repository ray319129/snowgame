...
export const CFG = {
  ...
  SHOP: {
    ...
    //  價格刻意壓低：中期（每秒收入約 25~45）就該買得起大半，
    //  最貴的也只要 24 萬 —— 裝飾是拿來收集的，不是拿來當終極目標的。
    decor: [
      // 可愛
      { id: 'snowballs',   name: '雪球堆',     cost: 300,    style: '可愛', x: 330, y: 1240 },
      { id: 'bunny',       name: '雪兔',       cost: 900,    style: '可愛', x: 264, y: 1232 },
      { id: 'penguin',     name: '小企鵝',     cost: 2200,   style: '可愛', x: 430, y: 1232 },
      { id: 'mushrooms',   name: '蘑菇叢',     cost: 4000,   style: '可愛', x: 246, y: 1352 },
      { id: 'sprite',      name: '小雪精靈',   cost: 7500,   style: '可愛', x: 512, y: 1352 },
      { id: 'fox',         name: '北極狐',     cost: 12000,  style: '可愛', x: 500, y: 1232 },
      { id: 'bearPlush',   name: '小熊玩偶',   cost: 18000,  style: '可愛', x: 300, y: 1502 },
      { id: 'pinwheel',    name: '彩色風車',   cost: 26000,  style: '可愛', x: 462, y: 1502 },
      { id: 'duckPond',    name: '冰池小鴨',   cost: 38000,  style: '可愛', x: 584, y: 1268 },
      { id: 'cocoa',       name: '熱可可攤',   cost: 55000,  style: '可愛', x: 196, y: 1268 },
      { id: 'gingerbread', name: '薑餅小屋',   cost: 90000,  style: '可愛', x: 604, y: 1436 },
      // 極地
      { id: 'snowman',     name: '雪人',       cost: 600,    style: '極地', x: 292, y: 1218 },
      { id: 'cairn',       name: '獵人石堆',   cost: 2800,   style: '極地', x: 468, y: 1218 },
      { id: 'totem',       name: '圖騰柱',     cost: 9000,   style: '極地', x: 264, y: 1478 },
      { id: 'flowerBed',   name: '冰原花圃',   cost: 20000,  style: '極地', x: 500, y: 1478 },
      { id: 'stoneRing',   name: '遠古石陣',   cost: 48000,  style: '極地', x: 176, y: 1436 },
      { id: 'whaleBone',   name: '鯨骨遺骸',   cost: 110000, style: '極地', x: 176, y: 1352 },
      // 節慶
      { id: 'lantern',     name: '暖光燈籠',   cost: 1600,   style: '節慶', x: 356, y: 1218 },
      { id: 'gifts',       name: '禮物堆',     cost: 6000,   style: '節慶', x: 404, y: 1218 },
      { id: 'banner',      name: '獵團旗幟',   cost: 15000,  style: '節慶', x: 604, y: 1352 },
      { id: 'brazier',     name: '節慶火盆',   cost: 34000,  style: '節慶', x: 340, y: 1502 },
      { id: 'bunting',     name: '慶典彩旗',   cost: 70000,  style: '節慶', x: 380, y: 1196 },
      // 奇幻
      { id: 'crystal',     name: '極光水晶',   cost: 5000,   style: '奇幻', x: 422, y: 1502 },
      { id: 'runeStone',   name: '浮空符石',   cost: 16000,  style: '奇幻', x: 584, y: 1478 },
      { id: 'starStone',   name: '星屑石',     cost: 42000,  style: '奇幻', x: 176, y: 1268 },
      { id: 'fountain',    name: '星輝噴泉',   cost: 95000,  style: '奇幻', x: 604, y: 1218 },
      { id: 'spire',       name: '極光尖塔',   cost: 160000, style: '奇幻', x: 380, y: 1534 },
      { id: 'iceArch',     name: '冰晶拱門',   cost: 240000, style: '奇幻', x: 176, y: 1196 },
    ],
    hat: [
      { id: 'beanie',   name: '毛線帽',   cost: 400,   style: '極地' },
      { id: 'explorer', name: '探險帽',   cost: 3000,  style: '極地' },
      { id: 'wreath',   name: '常青花環', cost: 11000, style: '節慶' },
      { id: 'antler',   name: '馴鹿角',   cost: 28000, style: '節慶' },
      { id: 'crown',    name: '極光王冠', cost: 75000, style: '奇幻' },
    ],
    //  助手制服：整支隊伍換色，一眼看得出是「我的隊伍」
    crew: [
      //  同風格要排在一起：商店是照 style 變化插分隔標題的
      { id: 'candy',  name: '糖果粉',   cost: 1200,   style: '可愛', tint: '#ffb8d0' },
      { id: 'mint',   name: '薄荷綠',   cost: 4500,   style: '可愛', tint: '#a8e8d0' },
      { id: 'lilac',  name: '薰衣草',   cost: 9000,   style: '可愛', tint: '#c8b8f0' },
      { id: 'none',   name: '原色',     cost: 0,      style: '極地', tint: null },
      { id: 'frost',  name: '霜藍制服', cost: 2000,   style: '極地', tint: '#74aae8' },
      { id: 'ember',  name: '暖火制服', cost: 8000,   style: '節慶', tint: '#ff9f5a' },
      { id: 'jade',   name: '翠玉制服', cost: 22000,  style: '節慶', tint: '#4aa863' },
      { id: 'aurora', name: '極光制服', cost: 60000,  style: '奇幻', tint: '#9fdff0' },
      { id: 'royal',  name: '御用金裝', cost: 150000, style: '奇幻', tint: '#ffd651' },
    ],
  },
